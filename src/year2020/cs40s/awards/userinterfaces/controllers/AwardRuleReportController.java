...
/**
 * AwardRuleReportController.java - description
 *
 * @author Mr. Wachs
 * @since 26-May-2020, 8:32:47 PM
 */
public class AwardRuleReportController 
{
    ...
    private AwardRuleReportView userInterface;
    private JFrame              parent;
    
    private int type;
    
    
    public AwardRuleReportController(
            JButton             sortByCoursesTakenButton, 
            JButton             sortByLastNamesButton, 
            JButton             sortByAveragesButton, 
            JButton             goBackButton, 
            JLabel              titleLabel, 
            JLabel              ruleDescriptionLabel, 
            ...
            AwardRuleReportView userInterface,
            JFrame              parent) {
        ...
        this.ruleDescriptionLabel     = ruleDescriptionLabel;        
