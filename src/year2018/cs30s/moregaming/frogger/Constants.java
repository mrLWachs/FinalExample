...
public class Constants 
{
    ...
    public static final int    FROGGER_MOVE_DIRECTIONS = Directions.FOUR_DIRECTIONS;
    ...
    public static final int    CAR_MOVE_DIRECTIONS     = Directions.TWO_DIRECTIONS;
    ...
    public static final int    LOG_MOVE_DIRECTIONS     = Directions.TWO_DIRECTIONS;
