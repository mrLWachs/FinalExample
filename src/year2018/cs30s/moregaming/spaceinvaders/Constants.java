...
public class Constants 
{
    ...
    public static final int    HERO_MOVE_DIRECTIONS         = Directions.TWO_DIRECTIONS;
    ...
    public static final int    HERO_BULLET_MOVE_DIRECTIONS  = Directions.FOUR_DIRECTIONS;
    ...
    public static final int    ENEMY_MOVE_DIRECTIONS        = Directions.TWO_DIRECTIONS;
    ...
    public static final int    ENEMY_BULLET_MOVE_DIRECTIONS = Directions.FOUR_DIRECTIONS;
