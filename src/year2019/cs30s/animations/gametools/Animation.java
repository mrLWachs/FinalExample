...
/**
 * Animation.java - represents an animation of images (picturebox objects) with
 * useful methods 
 *
 * @author Mr. Wachs 
 * @since 14-May-2019 
...
public class Animation 
{
    ...
    private void setFrames() {
        frames = new Picturebox[imageFiles.length];         // create array
        for (int i = 0; i < frames.length; i++) {           // traverse array
            frames[i] = new Picturebox(hitbox, imageFiles[i]);  // create frame
