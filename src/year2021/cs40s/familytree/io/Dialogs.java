...
package year2021.cs40s.familytree.io;
...
public class Dialogs
{
    ...
    /**
     * Outputs the passed text in a dialog with an error icon
     *
     * @param text the text to display
     */
    ...
    /**
     * Outputs the passed text in a dialog (with error icon), and gets typed 
     * user input
     *
     * @param text the text to display
     * @return the text the user types in
     */
    public String inputError(String text) {
        area.setText(text);
        Object object = JOptionPane.showInputDialog(parent, area,
                title, JOptionPane.ERROR_MESSAGE, icon, null, null);
        if (object == null) return null;
        return object.toString();
    }
